...
from Data_Processing_copy import *
...
def main():
    ...
    X_train_head_attr, X_train_tail_attr, y_train_head_attr, y_train_tail_attr = KGMTL_Data_local.create_attr_net_data(KGMTL_Data_local.train_rel_data,KGMTL_Data_local.train_attri_data)
    # print('x_train_head', X_train_head_attr)
    # print('y_train_head', y_train_head_attr)
    print(f'train att set: {len(X_train_head_attr)}')
    X_val_head_attr, X_val_tail_attr, y_val_head_attr, y_val_tail_attr = KGMTL_Data_local.create_attr_net_data(KGMTL_Data_local.val_rel_data,KGMTL_Data_local.valid_attri_data)
