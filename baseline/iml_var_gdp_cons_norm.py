...
config = {
    ...
    'save_path': './baseline/iml_cons_gdp/model_{}_cons_minmax.pt'.format(var_predict),
...
#             nn.Dropout(0.5),
    ...
    def cal_loss(self, preds, targets, x):
        ...
        for prediction, target in zip(preds, targets):
            ...
            punished_prediction = x_pop * x_gdp_per
...
import pickle
with open('baseline/iml_cons_gdp/loss_record_{}_minmax.pickle'.format(var_predict),'wb') as fw:
...
#print(preds)
save_pred(preds, 'baseline/iml_cons_gdp/pred_result_{}_minmax'.format(var_predict))
