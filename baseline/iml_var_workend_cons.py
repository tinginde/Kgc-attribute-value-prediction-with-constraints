...
min_cons=attri_data[attri_data['a']=='P2031'].v.min()
max_cons = attri_data[attri_data['a']=='P2031'].v.max()
...
#             nn.Dropout(0.5),
    ...
    def cal_loss(self, preds, targets,x):
        ...
        for prediction, target in zip(preds, targets):
            # Find the predicted values that are greater than birth
            x_constraint = x[:,work_start]*29+ 1980
